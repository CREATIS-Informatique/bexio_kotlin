...
data class Temps(@PrimaryKey(autoGenerate = true) var idRoom: Int?, var idBexio: Int?, var userId: Int?, var client_service_id: Int?, var text: String?, var pr_project_id: Int?, var date: String?, var duration: String?, var semaine: String?, var annee: String?) {
